    ...
    >
      <div className="bg-[#0C0C0C] text-white p-6 rounded-lg border border-[#272727]  w-11/12 md:w-2/3 lg:w-1/2">
        ...
        >
          ...
          ></textarea>
          <button
            className="mt-4 bg-green-100 text-black font-normal py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            onClick={() => onSubmit()}
          >
            Submit
          </button>
        ...
        >
          ...
          />
          <button
            className="mt-4 bg-green-100 hover:bg-green-100/70 text-black font-normal py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            onClick={() => onSubmit()}
          >
            Unlock
          </button>
